## DOM Inspector Toolbar Button [Firefox Addon]

This addon adds a DOM Inspector toolbar button and requieres the DOM Inspector addon.

---

To **install** the addon go to [releases](https://github.com/mortalis13/DOM-Inspector-Toolbar-Button-XPI/releases) and click on the **.xpi** file or download and drag it to the browser window.
